...
class FieldSectionRenderer extends SectionRenderer {
  FieldSectionRenderer(flutter_widget.Widget? child) : super(child: child);
  ...
  flutter_widget.Widget render(
    ...
    return child ?? const flutter_widget.SizedBox.shrink();
  }
}
