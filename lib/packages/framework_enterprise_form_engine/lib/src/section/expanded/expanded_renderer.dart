...
class ExpandedSectionRenderer extends SectionRenderer {
  ExpandedSectionRenderer(flutter_widget.Widget? child) : super(child: child);
  ...
  flutter_widget.Widget render(
    ...
    return flutter_widget.Expanded(
      flex: section.flex ?? 1,
